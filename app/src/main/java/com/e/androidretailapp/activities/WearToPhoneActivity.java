...
public class WearToPhoneActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wear_to_phone);
    ...
    public class SendMessageToDataLayer extends Thread{
        ...
        public void run() {
            ...
            for(Node node : nodesList.getNodes())
            {
                ...
                {
                    Toast.makeText(WearToPhoneActivity.this, "Message sent to :  " + node.getDisplayName() + " node id : " + node.getId(), Toast.LENGTH_SHORT).show();

                }
                else
                {
                    Toast.makeText(WearToPhoneActivity.this, "Error while sending a message to node", Toast.LENGTH_SHORT).show();
                }
            }
